...
from modules.resnet import deformable_resnet18
from modules.segmentation_head import DBHead
from modules.segmentation_body import FPN

backbone_dict = {'deformable_resnet18': {'models': deformable_resnet18, 'out': [64, 128, 256, 512]}}
...
class DBTextModel(nn.Module):
    def __init__(self):
        ...
        super().__init__()
        pretrained = True
        backbone_name = "deformable_resnet18"
